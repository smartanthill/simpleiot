...
#define MEMORY_HANDLE_SAGDP_LSM_1 4
#define MEMORY_HANDLE_SAGDP_LSM_1_SAOUDP_ADDR 5
#define MEMORY_HANDLE_SAGDP_LSM_2 6
#define MEMORY_HANDLE_SAGDP_LSM_2_SAOUDP_ADDR 7
